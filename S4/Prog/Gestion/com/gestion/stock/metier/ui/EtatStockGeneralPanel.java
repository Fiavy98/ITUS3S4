...
public class EtatStockGeneralPanel extends JPanel {
    ...
    private void initTable() {
        tableModel = new DefaultTableModel(new String[]{
            "Date", "Article", "Type", "Méthode", "Qté +/-", "PU", "Valeur", "Stock(qté)", "Valeur stock cumulée", "CUMP", "Source tiers", "Référence", "article_id", "mouvement_id"
        }, 0) {
            @Override
        ...
        table.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                if (e.getClickCount() == 2) {
                    ...
                    if (row >= 0) {
                        Object mouvementIdValue = table.getValueAt(row, 13);
