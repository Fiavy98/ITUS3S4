...
public class Mouvement {
    ...
    public Mouvement(int id, int produitId, TypeMouvement type,
                     int quantite, int quantiteRestante, double prixUnitaire, LocalDateTime date) {
        this.id = id;
    ...
    public void setQuantiteRestante(int quantiteRestante) { this.quantiteRestante = quantiteRestante; }
