...
//================================ TABLE ===================================================
            ...
            else if (command.toUpperCase().startsWith("FIDIO")  // JOIN
                && command.toUpperCase().contains("MIARAKA AMIN'NY")) {
                FonctionCommand.join(command);
            }

            else if (command.toUpperCase().startsWith("FIDIO")) { //SELECT
