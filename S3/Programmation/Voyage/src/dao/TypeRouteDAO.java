...
public class TypeRouteDAO {
    ...
    // --- Récupérer nom par ID ---
     public static TypeRoute getTypeById(int idTypeRoute) {
        ...
        public static TypeRoute getByName(String nom) {

        String sql = "SELECT id, nom FROM type_route WHERE LOWER(nom) = ?";
        ...
        try (Connection conn = OracleConnection.getConnection();
            ...
            System.out.println("❌ Erreur SQL getByName(TypeRoute) : " + e.getMessage());
        }
